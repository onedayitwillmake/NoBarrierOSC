...
(function(){
	...
	JoystickDemo.WorldEntityDescription = function( aGameInstance, allEntities ) {
	...
	JoystickDemo.WorldEntityDescription.prototype = {
		entities						: null,
		gameClock						: 0,
		gameTick						: 0,
		...
		getEntityDescriptionAsString	: function() {
			...
			this.allEntities.forEach( function(key, entity) {
                if( entity.entityType !== 'joystick' ) return;
